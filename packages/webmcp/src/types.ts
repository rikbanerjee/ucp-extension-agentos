...
export interface WebMcpToolDescriptor { name: WebMcpToolName; title: string; description: string; inputSchema: JsonObject; annotations: WebMcpToolAnnotations; execute(input: JsonObject, options?: { signal?: AbortSignal }): Promise<JsonObject>; }
