...
const agentReadiness = [
  ...
  {
    id: 'promotions',
    check: 'Promotions & stacking',
    question: 'Do active offers surface at browse time, with deterministic stacking rules?',
    extension: 'RAOS-0006 promo pricing',
    breaksWithout: 'Weekly sale never factors into the recommendation — or agent stacks offers that shouldn\'t combine, and the effective price falls below cost.',
  },
  {
    id: 'loyalty',
    check: 'Loyalty & member value',
    question: 'Can agents show a buyer how many points they\'d earn, and whether their tier changes the price — before checkout?',
    extension: 'RAOS-0009 loyalty',
    breaksWithout: 'Loyalty is invisible at browse time. The agent quotes the wrong price for a gold member, or misses the "link account to earn points" prompt that would have converted the sale.',
  },
  {
    id: 'delivery-restrictions',
    check: 'Delivery & age restrictions',
    question: 'For regulated goods (alcohol, cannabis, pharmacy) — are geo eligibility and age requirements machine-readable before cart?',
    extension: 'RAOS-0011 restricted goods',
    breaksWithout: 'Agent routes a buyer in a restricted state to checkout for an item that can\'t ship there. Or routes an underage buyer to a cannabis checkout. Legal exposure and abandoned carts.',
  },
  {
    id: 'explainability',
    ...
    breaksWithout: 'Merchant and buyer have no visibility into why an item was blocked or a price changed — trust erodes.',
  },
];
...
const problems = [
  ...
  },
  {
    ...
    body: "Wholesale listings, age-restricted products, regulated goods, local-delivery-only items — agents don't know your rules, so they route buyers into dead ends. For alcohol, cannabis, or pharmacy items, that's not just a bad experience; it's a compliance problem.",
  },
  {
    icon: Zap,
    title: 'Promos and loyalty are invisible',
    body: "Your sale prices, mix-and-match deals, and loyalty points exist — agents just can't see them at browse time. A gold member gets quoted the same price as a guest. A loyal customer earns nothing because the agent never knew to ask.",
  },
];
      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <div className="mt-10 flex items-center justify-center gap-4 flex-wrap">
            ...
            >
              Check your store&apos;s agent-readiness <ArrowRight className="w-4 h-4" />
            </a>
            <Link
              href="/guided"
        ...
        <div id="readiness" className="mb-20 scroll-mt-8">
          ...
          <div className="mt-5 text-center">
            <a
              href="mailto:rikbanerjee007@gmail.com?subject=RetailAgentOS%20%E2%80%94%20comparing%20notes"
              className="text-sm font-medium text-slate-600 hover:text-slate-900 transition-colors"
            >
              I&apos;m building this in the open — want to compare notes on your store? Get in touch →
            </a>
          </div>
        </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-bold text-slate-900">Building this in the open</h2>
            <p className="mt-2 text-slate-500 text-sm max-w-xl mx-auto">
              RetailAgentOS is an independent project I&apos;m working through on my own time, nights
              and weekends — published as it&apos;s built. Follow the work, or compare notes if you run a store.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
            <Link
              href="/buildlog"
              className="group block rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:border-slate-400 hover:shadow-sm transition-all"
            >
              <div className="font-semibold text-slate-900 mb-1 flex items-center gap-1.5">
                Follow the build <ArrowRight className="w-3.5 h-3.5 text-slate-400 group-hover:text-slate-700 transition-colors" />
              </div>
              <p className="text-sm text-slate-600 leading-relaxed">A weekly log of what ships, in plain language.</p>
            </Link>
            <a
              href="mailto:rikbanerjee007@gmail.com?subject=RetailAgentOS%20%E2%80%94%20comparing%20notes"
              className="group block rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:border-slate-400 hover:shadow-sm transition-all"
            >
              <div className="font-semibold text-slate-900 mb-1 flex items-center gap-1.5">
                Compare notes <ArrowRight className="w-3.5 h-3.5 text-slate-400 group-hover:text-slate-700 transition-colors" />
              </div>
              <p className="text-sm text-slate-600 leading-relaxed">Run a store and want to talk through agent-readiness? Get in touch.</p>
            </a>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-900 p-10 text-center shadow-lg">
          ...
          <p className="text-slate-400 text-sm leading-relaxed max-w-md mx-auto mb-8">
            An independent project, published as it&apos;s built. See what ships each week,
            try the live demo, and weigh in on the open questions.
          </p>
          <div className="flex items-center justify-center gap-3 flex-wrap">
            ...
            <Link
              href="/demo"
              className="inline-flex items-center gap-2 rounded-md border border-white/20 bg-transparent px-5 py-2.5 text-sm font-semibold text-white hover:bg-white/10 transition-colors"
            >
              Try the live demo
            </Link>
          </div>
