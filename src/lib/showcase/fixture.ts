...
export const STOREFRONTS: Record<ShowcaseStoreId, ShowcaseStorefront> = {
  ...
  thecustomhub: { id: 'thecustomhub', displayName: 'TheCustomHub', fixtureClassification: 'authorized controlled quote fixture — not live', merchant: customMerchant, variants: [customVariant], catalogVersion: 'thecustomhub-catalog-v1', policyVersion: 'thecustomhub-policy-v1', fulfillmentModes: ['shipping'], substitutionsSupported: false, quoteSupported: true, memberPricingSupported: false, shopperContext: { marketRegion: 'US', fulfillmentMode: 'shipping', contextSource: 'controlled_fixture' }, scenarioExplanation: 'A controlled custom-merchandise request must go to merchant review; no fixed price, cart, order, payment, or checkout is exposed.' },
};
